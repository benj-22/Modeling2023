...
//Last modified: Fri, Sep 08, 2023 03:45:20 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "C44162A6-4005-5290-2B63-BEA4CBEC957E";
...
createNode transform -s -n "top";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -553.23742776530707 262.90304273728634 791.87401215413036 ;
	setAttr ".r" -type "double3" -14.999999999999998 -34.999999999999879 0 ;
	setAttr ".rpt" -type "double3" 4.2621741742019476e-14 2.2352008359945037e-14 2.2352008359945148e-14 ;
createNode camera -s -n "topShape" -p "top";
	...
	setAttr ".coi" 1000.1;
	setAttr ".ow" 26.494572748137386;
	setAttr ".imn" -type "string" "top";
	setAttr ".den" -type "string" "top_depth";
	setAttr ".man" -type "string" "top_mask";
	setAttr ".tp" -type "double3" -0.24947710126303754 4.0351432085367485 0.35460762535433332 ;
...
createNode transform -n "pCylinder3";
	...
	setAttr ".s" -type "double3" 0.31268912627107825 0.31268912627107825 0.31268912627107825 ;
	setAttr ".rp" -type "double3" -0.31268907442293026 -5.6687581057757424 8.348613896769767e-10 ;
	setAttr ".sp" -type "double3" -0.99999983418627691 -18.129054161165008 2.6699405880625804e-09 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "579B3D4D-4A7A-ECFB-D70F-D7B5090FAE65";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "AD045EF6-4BF8-1DFC-B152-F986603602E3";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "E04B56A5-4B26-E330-8495-32BED835FFCD";
createNode displayLayerManager -n "layerManager";
	rename -uid "775060E8-466B-FB6A-4CA5-EC839ACC86DA";
createNode displayLayer -n "defaultLayer";
	rename -uid "A4361A75-45F6-5C35-6ABA-A28AA98FBEC7";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "3813D813-4E2C-7D36-1A79-EB9AB052D98B";
